...
const I18N = {
  ...
  en: {
    ...
    'photo.clear': 'Clear',
    'photo.demoHint': 'Upload a real patient photo (front view, even lighting) to render a clinical-grade before/after preview.',
  ...
  'pt-BR': {
    ...
    'photo.clear': 'Limpar',
    'photo.demoHint': 'Envie uma foto real do paciente (vista frontal, iluminação uniforme) para gerar uma prévia clínica antes/depois.',
  ...
  es: {
    ...
    'photo.clear': 'Limpiar',
    'photo.demoHint': 'Cargue una foto real del paciente (vista frontal, iluminación uniforme) para generar una vista previa clínica del antes/después.',
    'photo.altBefore': 'Paciente antes',
